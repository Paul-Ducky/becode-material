...
## The Mission
Today you are going to combine your awesome OOP powers with a database.
...
You don't need to worry about infinite loops in this exercise.
...
### Importing the data
With this exercise you can find an [SQL file](resources/import.sql) you can import into a database, the previous exercises have shown you the command to do this.
